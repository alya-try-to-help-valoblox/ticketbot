...
TERMS_PARTS = [
    ...
    'Under no circumstances shall the server owner, founders, administrators, moderators, assistants, affiliates, contractors, successors, assigns, representatives, collaborators, or any individual or entity associated directly or indirectly with the server be held liable for any direct, indirect, incidental, consequential, punitive, exemplary, financial, reputational, digital, virtual, physical, material, or immaterial damages arising out of or in connection with the use of, inability to use, interruption of, suspension of, modification of, or termination of any service or feature, including but not limited to loss of profits, revenue, business opportunity, data, digital assets, account standing, community reputation, algorithmic visibility, platform access, or third-party relationships, regardless of the legal theory invoked and to the maximum extent permitted by applicable law. Without limiting the generality of the foregoing provisions, you expressly acknowledge and agree that the administration shall not be responsible or liable for any perceived or actual interruption, degradation, delay, miscommunication, data inconsistency, temporary unavailability, permanent discontinuation, restructuring, modification, reclassification, suspension, algorithmic filtering, automated moderation impact, shadow restriction, access limitation, or structural alteration of any channel, role, category, system, service tier, or digital feature within the server environment.',
    ...
    'You further acknowledge that the administration may, at its sole discretion, modify service structures, pricing models, access tiers, benefit allocations, feature availability, automation logic, or community privileges without incurring liability for perceived loss of value, expectation misalignment, or comparative disadvantage relative to prior conditions. No historical configuration of services shall create an ongoing obligation to maintain identical structures in the future. In addition, force majeure events shall include, without limitation, acts of God, natural disasters, earthquakes, floods, fires, pandemics, epidemics, governmental restrictions, regulatory changes, sanctions, embargoes, civil unrest, riots, war, terrorism, labor disputes, infrastructure failures, internet backbone outages, DNS failures, hosting provider disruptions, data center incidents, cybersecurity attacks, ransomware incidents, distributed denial-of-service attacks, third-party API shutdowns, payment processor suspensions, platform-wide moderation sweeps, or any event beyond the reasonable control of the administration, and no such event shall give rise to liability, compensation, refund obligation, or damages claim.',
    ...
    'To the maximum extent permitted by applicable law, you agree that the total cumulative liability of the administration, regardless of the number of claims, causes of action, legal theories, or procedural mechanisms invoked, shall not exceed the total amount actually paid by you, if any, for the specific service directly giving rise to the claim, and in no event shall the administration be liable for consequential, incidental, indirect, punitive, exemplary, reputational, or speculative damages exceeding that amount. You further agree that any dispute resolution process shall be conducted individually and not as part of any collective, consolidated, coordinated, representative, or class-based proceeding. You irrevocably waive any right to participate in class actions, collective arbitration, mass claims, or representative litigation of any kind. You further acknowledge that electronic acceptance of these Terms through continued server presence constitutes valid and binding agreement equivalent to a handwritten signature.',
    ...
    'To the fullest extent permitted by law, any dispute, controversy, or claim arising out of or relating to these Terms shall be resolved exclusively through confidential binding arbitration conducted in a jurisdiction determined solely by the administration, and you waive any right to trial by jury or participation in class actions, collective proceedings, or representative lawsuits. Any claim must be brought within a strictly limited time period of one (1) year from the date the cause of action arises, after which it shall be permanently barred. If any provision of these Terms is deemed invalid, unlawful, or unenforceable, such provision shall be severed without affecting the remaining provisions, which shall remain in full force and effect. These Terms constitute the entire agreement between you and the administration and supersede all prior communications, representations, expectations, understandings, or agreements, whether oral or written.\n\n'
